...
const Banner: React.FC<Props> = ({lastData}) => {
  ...
  return (
    <>
    {lastData.error == 'uni_nursing_houses_name' ? 
    <div className=' text-neutral flex px-10 bg-err py-5 rounded-xl text-lg'>Error : The name of this nursing home has been registered!</div>
    : (lastData.error == 'something_went_wrong' ?
    <div className=' text-neutral flex px-10 bg-err py-5 rounded-xl text-lg'>Error : Failed to register. Something went wrong!</div>
