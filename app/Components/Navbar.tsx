  ...
  return (
    <div className={stateEA?"w-full h-28 m bg-neutral/30 pb-6 flex items-end mt-8":"w-full h-28 backdrop-blur-sm bg-neutral/30 sticky top-0 z-10 pb-6 flex items-end mt-8"}>
      <div className='w-full h-14 bg-gray-300 rounded-s-lg flex items-center justify-between pl-5 '>
          <div id="navbar-title" className='text-primary text-lg w-40 shrink-0'>
              {stateManu?'บ้านพักคนชรา':'บทความการเงิน'}
          </div>
          {stateEA?null
          :<>
            <div id="navbar-search-container" className='w-1/2 h-9 flex justify-center bg-neutral rounded-md min-w-32'>
              <div id="navbar-search-icon" className={search?'w-10 h-7 flex items-center justify-center text-primary2 my-auto':'w-10 h-7 flex items-center justify-center text-gray-300 my-auto'}>
